...
module MomentumSmearing ChargedHadronMomentumSmearing {
	...
	(abs(eta) <= 1.5) * (pt > 0.1   && pt <= 1.0)   * (0.02) + 
...
module EnergySmearing ElectronEnergySmearing {
    ...
    set ResolutionFormula {
	(abs(eta) <= 2.5) * (energy > 0.1   && energy <= 2.0e1) * (energy*0.0225) + 
...
module BTagging BTagging_ak5 {
    set PartonInputArray Delphes/partons
    set JetInputArray JetPileUpSubtractor_ak5/jets
...
module BTagging BTagging_CA8 {
    set PartonInputArray Delphes/partons
    set JetInputArray JetPileUpSubtractor_CA8/jets
