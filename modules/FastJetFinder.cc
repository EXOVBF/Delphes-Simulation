...
void FastJetFinder::Init()
{
	...
	break;
    case 2:
	fAreaDefinition = new AreaDefinition(one_ghost_passive_area, GhostedAreaSpec(fGhostEtaMax, fRepeat, fGhostArea, 
										     fGridScatter, fPtScatter, fMeanGhostPt));
	break;
    case 3:
	fAreaDefinition = new AreaDefinition(passive_area, GhostedAreaSpec(fGhostEtaMax, fRepeat, fGhostArea, 
									   fGridScatter, fPtScatter, fMeanGhostPt));
	break;
    case 4:
	...
	break;
    case 5:
	fAreaDefinition = new AreaDefinition(active_area, GhostedAreaSpec(fGhostEtaMax, fRepeat, fGhostArea, 
									  fGridScatter, fPtScatter, fMeanGhostPt));
	break;
    default:
    case 0:
...
void FastJetFinder::Process()
{
    ...
    //cout << "here " << GetInt("JetAlgorithm", 6) << "  " << inputList.size() << endl;
	...
	if(fComputePruning)
	{
	    fPruner = new Pruner(*fDefinition4Pruner, 0.1, fRcutOff);
